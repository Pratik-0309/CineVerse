      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pb-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-gray-400 text-md max-w-xs">
              Your ultimate destination for discovering and tracking your favorite cinema.
            </p>
          </div>
          ...
          <div className="flex gap-12">
            <div className="flex flex-col gap-3">
              ...
              <Link to="/favourites" className="text-gray-400 hover:text-white text-sm transition-colors">Favourites</Link>
              <Link to="/watchlist" className="text-gray-400 hover:text-white text-sm transition-colors">Watchlist</Link>
            </div>
            <div className="flex flex-col gap-3">
              ...
              <Link to="/register" className="text-gray-400 hover:text-white text-sm transition-colors">Get Started</Link>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            {/* Social Icons or extra links can go here */}
